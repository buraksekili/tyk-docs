...
If you are deploying the Master Data Centre in an MDCB deployment then you can set the `mdcb.enabled` option in your `vuales.yaml` to true to add the MDCB component to your cluster.
