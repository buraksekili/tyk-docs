...
This demo will run Tyk On-Premises on your machine, which contains 5 containers: Tyk Gateway, Tyk Dashboard, Tyk Pump, Redis and either MongoDB or one of our supported [SQL Platforms]({{< ref "/content/tyk-stack/tyk-manager/database-options.md" >}}). 
