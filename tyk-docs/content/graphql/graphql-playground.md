...
While creating or editing a GraphQL API, all the changes made, can be tested using  GraphiQL playground which sits under the `Playground` tab in `API Designer`.
