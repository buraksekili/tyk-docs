...
Response provides the authorization code as `code` and the redirect URL as `redirect_to`. It is expected that the 3rd party authentication server will redirect the user to the redirect URL.
